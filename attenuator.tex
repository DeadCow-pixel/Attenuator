...
In an ideal, noiseless setup, homodyne detection implements projective measurements onto quadrature eigenstates, whereas double homodyne detection realizes a generalized measurement described by a rank-one positive operator-valued measure (POVM) onto coherent states~\cite{Yuen:ol:1983,Yuen:ol:1983,vogel2006quantum, Serafini:bk:2023}.
