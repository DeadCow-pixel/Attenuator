...
A practical coherent receiver is charactarized by a wide range of imperfections, such as non-unit photodetector efficiencies, electronic noise, beam-splitter imbalance, and mismatched responses of the detection branches~\cite{Pereira2021,Barchielli_2022,PRXQuantum.3.010341,hajomer2025finite,Bartlett:25}.
...
~\cite{Davies1970,Holevo1973Statistical,Ozawa1984}. Using a particular channel representation in the security analysis introduces an additional physical assumption whose interpretation depends on whether receiver noise is trusted. In a trusted-detector model, the degrees of freedom associated with calibrated
...
The purification of a fixed state is related by an
