...
reproduce the target noisy Gaussian measurement. For covariance matrix, this condition is expressed by
...
parameter $r$. The parameter $r$ arises from the ideal projective squeezed-state measurement, and the noisy POVM is given by action of a chosen Gaussian channel on this projector. The requirement that the excess-noise covariance matrix be positive
...
Eqs.~\eqref{eq:cos-theta-dh} and~\eqref{eq:a_def}. In the attenuator construction adopted here, the generally anisotropic
